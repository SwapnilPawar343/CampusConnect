            ...
            <div key={q.id} className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="flex justify-between items-start mb-3">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-sm text-gray-500">{q.replies.length} {q.replies.length === 1 ? "Reply" : "Replies"}</span>
                  <button
                    ...
                    aria-expanded={!!showReplyBox[q.id]}
                  >
                    {showReplyBox[q.id] ? "Hide Replies" : "View Replies"}
                    <svg className={`w-4 h-4 transition-transform ${showReplyBox[q.id] ? 'rotate-180' : ''}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {showReplyBox[q.id] && (
                <div className="mt-4 bg-gray-50 border border-gray-200 rounded p-4 shadow-sm">
                  ...
                  {q.replies.length > 0 ? (
                    ...
                    <div className="text-sm text-gray-500">No replies yet. Be the first to reply.</div>
                  )}
                </div>
              )}
            </div>
